...
import { getPaymentUpdateUrl } from "./payment-url-helpers";
...
export async function sendDunningEmail(
  ...
  // Generate payment update URL (supports both Stripe and Paddle)
  const cardUpdateUrl = getPaymentUpdateUrl(payment);
